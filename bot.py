...
PROXY = ('proxy.soax.com', 9010,'Rx8vlf9yU7VeqsDW', 'wifi;fr;;;')
...
def main(row_indexes):
    ...
    for row_index in row_indexes:
        for match in matches_data:
            ...
            thread = threading.Thread(target=start, args=(link,categories))
            thread.start()
